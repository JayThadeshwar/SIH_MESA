...
const AddChapter = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (typeBtn == "text") {
      ...
      data.append(
        "langCode",
        JSON.parse(localStorage.getItem("voice_origin"))["value"]
      );
    ...
    <div className="addChaper">
      ...
      <div className="container d-flex flex-column gap-4">
        <h1
          ...
          style={{ fontWeight: "900", color: "#383A3D" }}
        >
          ADD YOUR CHAPTER
        </h1>
        {load ? (
          ...
          <>
            <div className="container d-flex flex-column gap-4">
              <form className={""} style={{ margin: "0 300px" }}>
                <div className="mb-3">
                  <label for="chapterName" className="form-label fs-3">
                    Enter Chapter Name <code>*</code>
                  </label>
                  <input
                  ...
                  >
                    ...
                    {typeBtn === "text" && (
                      ...
                      >
                        ...
                        >
                          Enter Chapter Content<code>*</code>
                        </label>
                        <textarea
                          className="form-control"
                    ...
                    {typeBtn === "link" && (
                      <div
                        ...
                        style={{ margin: "30px 0px", padding: "0px" }}
                      >
                        <label for="videoLink" className="form-label fs-3">
                          Enter Video Link<code>*</code>
                        </label>
                        <input
                          type="link"
                          className="form-control"
                    ...
                    {typeBtn === "input" && (
                      <div style={{ margin: "15px 0px" }}>
                        <div>
                          ...
                          />
                          <small>
                            Note: Configure Voice assistant's origin settings to
                            get appropriate content transcription
                          </small>
                        </div>
                      </div>
                    )}
                    ...
                    {typeBtn === "image" && (
                      <div
                        ...
                        style={{ margin: "30px 0px", padding: "0px" }}
                      >
                        <label for="imageUpload" className="form-label fs-3">
                    ...
                    {typeBtn === "pdf" && (
                      <div
                        ...
                        style={{ margin: "30px 0px", padding: "0px" }}
                      >
                        <label for="pdfUpload" className="form-label fs-3">
                          Upload PDF<code>*</code>
                        </label>
                        <input
                          type="file"
                          accept=".pdf"
                    ...
                    <div className="mt-5 d-flex justify-content-between">
                      <button
                        ...
                        disabled={getContentBtnDisabled}
                      >
                        GET CONTENT
                      </button>
                      <button
