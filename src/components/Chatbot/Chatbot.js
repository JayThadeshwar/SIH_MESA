...
import stop from "../../../src/images/stop.png";
...
function Chatbot() {
  ...
  const [projectId, setProjectId] = useState(
    location.state.projectId || "dinning-out"
  );
  ...
  useEffect(() => {
    ...
    socketiovar.on("results-error", function (data) {
      console.log("error");
      alert(data);
    });
    ...
    socketiovar.on("results-tts", function (data) {
      playOutput(data);
    });
    setsocketio(socketiovar);
    return () => {
      socketiovar.close();
    };
  }, []);
    ...
    if (message.content && message.content.text && message.content.text.text) {
      if (message.who === "bot") {
        return (
          <MessageBot
            langCode={toInput}
            isConvo={projectId === "stt-ewll"}
            msg={`conversation-item conversation-item-${i} bot`}
            key={i}
            who={message.who}
            text={message.content.text.text}
            translation={message.content.text.translation}
        ...
        return (
          <MessageHuman
            langCode={fromInput}
            isConvo={projectId === "stt-ewll"}
            msg={`conversation-item conversation-item-${i} human`}
            key={i}
            who={message.who}
            text={message.content.text.text}
          ></MessageHuman>
      ...
      <div className="learn-main">
        <div className="bot-view learning-unit-view has-scroll-animations ember-view">
          ...
          <div class="bot-conversation" style={{ touchAction: "none" }}>
            <div
              id="bot-convo-id"
              class="bot-conversation-inner"
              style={{
                transform: "translate(0px, 0px) translateZ(0px)",
                maxHeight: projectId !== "stt-ewll" ? "250px" : "370px",
                height: projectId !== "stt-ewll" ? "250px" : "370px",
                overflowY: "auto",
              }}
            >
                ...
                <div class="bot-info">
                  <div class="bubble">
                    <div class="text is-light is-size-7">
                      <span
                        id="ember292"
                        class="auto-font-width center-text ember-view"
                      >
                        Things you can say:
                ...
                <div class="input-area-inner">
                  {projectId !== "stt-ewll" && (
                    <div class="toggle-setting is-light is-size-7">
                      ...
                      <div
                        id="ember294"
                        class="switch-toggle-button ember-view"
                      >
                        <input
                          id="switch-toggle-translation"
                          onInput={() => {
                        ...
                        />
                        <label
                          for="switch-toggle-translation"
                          class="switch-label"
                        >
                          <div class="switch-label-after iscroll-exception">
                            <div
                              id="ember296"
                              class="ripple-container ember-view"
                              style={{
                                borderRadius: "50%",
                                display: "none",
                                height: "38px",
                  ...
                  {!hideText ? (
                    <>
                      <div
                        class="type-input show"
                        style={{
                          bottom:
                            projectId !== "stt-ewll" ? "-130px" : "-100px",
                        }}
                      >
                      ...
                      <button
                        class="btn btn-type-switch type"
                        onClick={() => setHideText(true)}
                        data-ember-action=""
                        data-ember-action-112="112"
                        style={{
                          position: "absolute",
                          bottom:
                            projectId !== "stt-ewll" ? "-130px" : "-100px",
                    ...
                    <>
                      <div class="microphone ">
                        <div
                          id="ember111"
                          class="speech-record-button ember-view"
                        >
                          <button
                          ...
                          >
                            <img
                              src={
                                isRecording
                                  ? stop
                                  : `https://d37sy4vufic209.cloudfront.net/images/quizzes/microphone@2x-e1abfa9ce8480147c6e97cba029daccf.png`
                              }
